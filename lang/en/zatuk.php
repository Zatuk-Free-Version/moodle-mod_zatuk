...
$string['browse_video_description'] = 'Required: All course videos will be displayed in this section, regardless of their associated courses.';
$string['choose_video'] = 'Choose video';
$string['courseactions'] = 'Actions for course';
...
$string['privacy:metadata:zatuk_uploaded_videos'] = 'A record of zatuk video upload.';
$string['privacy:metadata:zatuk_uploaded_videos:description'] = 'Uploaded video description.';
$string['privacy:metadata:zatuk_uploaded_videos:filename'] = 'Uploaded video filename.';
$string['privacy:metadata:zatuk_uploaded_videos:filepath'] = 'Uploaded video filepath.';
$string['privacy:metadata:zatuk_uploaded_videos:public'] = 'Status of the uploaded video.';
$string['privacy:metadata:zatuk_uploaded_videos:timecreated'] = 'Video uploaded time.';
$string['privacy:metadata:zatuk_uploaded_videos:title'] = 'Uploaded video title.';
$string['privacy:metadata:zatuk_uploaded_videos:usercreated'] = 'ID of the user for the upload.';
$string['privacy:metadata:zatuk_uploaded_videos:videoid'] = 'Uploaded video id.';
$string['public'] = 'Public';
$string['publicinfo'] = 'public';
$string['publicinfo_help'] = 'Please be aware that if the box is left unchecked, the video will only be viewable by the teacher who uploaded it and the administrators of that particular course. Other teachers will not have access to the video. Conversely, if the box is checked, the video will be available to all teachers and administrators in the course. Regardless of the privacy setting, users will be able to view the video once the teacher has uploaded it as an activity in the course.';
...
$string['title'] = 'Title';
$string['title_search'] = 'Title Search';
...
$string['videoupdated'] = 'Zatuk content updated successfully.';
$string['videouploaded'] = 'Thank you for uploading the video! It will be accessible for use once it has been successfully published on the Zatuk streaming platform, and the status will be updated to "<b>Published</b>" on the LMS.';
