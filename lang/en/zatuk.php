...
$string['videouploaded'] = 'Thank you for uploading your video! It will be published once it has been successfully uploaded to the Zatuk streaming platform. You\'ll see the status update to "<b>Published</b>" when it\'s ready to use.';
